...
async def test_2(dut):
   ...
   csi = CSI(dut, dut.cam_dphy_dat, period_ns=1.096, fps_Hz=60, line_length=1280, frame_length=720, frame_blank=130, num_lane=num_lane, dinvert=dinvert, raw=8, uniform_data=True, start_value=0x01)
