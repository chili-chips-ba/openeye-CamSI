...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_LED0_BIT" -parent ${Page_0}


}

proc update_PARAM_VALUE.C_LED0_BIT { PARAM_VALUE.C_LED0_BIT } {
	# Procedure called to update C_LED0_BIT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_LED0_BIT { PARAM_VALUE.C_LED0_BIT } {
	# Procedure called to validate C_LED0_BIT
	return true
}
...
proc update_MODELPARAM_VALUE.C_LED0_BIT { MODELPARAM_VALUE.C_LED0_BIT PARAM_VALUE.C_LED0_BIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_LED0_BIT}] ${MODELPARAM_VALUE.C_LED0_BIT}
}
