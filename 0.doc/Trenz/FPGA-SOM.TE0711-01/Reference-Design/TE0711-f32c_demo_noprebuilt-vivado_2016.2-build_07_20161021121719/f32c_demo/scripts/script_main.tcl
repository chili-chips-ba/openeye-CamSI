...
if {$sdsoc_available} {
  ...
  puts "Info:(TE) Source Xilinx SDSoC Scripts (${x_dir}/SDSoC/${x_vers}/scripts/vivado/sdsoc_pfm.tcl)."
  source -notrace ${x_dir}/SDSoC/${x_vers}/scripts/vivado/sdsoc_pfm.tcl
}
puts "-----------------------------------------------------------------------"
