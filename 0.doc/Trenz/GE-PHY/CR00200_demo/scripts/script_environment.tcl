...
# ------------------------------------------
# -- $Date:  2022/09/13  | $Author: Hartfiel, John
# -- - simple bugfix printf for source_file
# ------------------------------------------
# -- $Date:  2022/09/22  | $Author: Hartfiel, John
# -- - typo
# ------------------------------------------
    ...
    proc setup_extended_config {} {
      ...
      if {![string match -nocase "NA" $config_sw_extpll ] } {
          ...
          if { [file exists $source_file] } { 
            ...
            TE::UTILS::te_msg TE_INIT-235 {CRITICAL WARNING} "Extendion source not available, please check : source_file"
          }
      }
